<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="KingdomConfeitaria.Cadastro" %>
    ...
    <form id="form1" runat="server">
        <div class="cadastro-container">
            ...
            <div class="text-center">
                <a href="Login.aspx" class="text-decoration-none">Já tem conta? Faça login</a>
            </div>
        </div>
    </form>
