<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="KingdomConfeitaria.paginas.Login" EnableViewState="false" ViewStateMode="Disabled" %>
...
<head runat="server">
    ...
    <style>
        /* Estilos espec�ficos da p�gina Login */
        body {
            padding-top: 0;
        }
        .header-top {
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-container">
            ...
            <div class="text-center mb-3">
                <a href="Cadastro.aspx" class="text-decoration-none">N�o tem conta? Cadastre-se</a>
            </div>
