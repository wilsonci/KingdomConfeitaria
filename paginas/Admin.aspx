<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="KingdomConfeitaria.paginas.Admin" EnableViewState="false" ViewStateMode="Disabled" %>
...
<head runat="server">
    ...
    <title>Administra��o - Kingdom Confeitaria</title>
    ...
    <style>
        ...
        /* Estilos para visualiza��o de logs em �rvore */
        .log-tree {
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="container-main">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><i class="fas fa-cog"></i> Administra��o</h1>
                </div>
                ...
                <ul class="nav nav-tabs mb-4" id="adminTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="configuracoes-tab" data-bs-toggle="tab" data-bs-target="#configuracoes" type="button" role="tab">
                            <i class="fas fa-cog"></i> Configura��es
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="adminTabContent">
                    ...
                    <div class="tab-pane fade" id="reservas" role="tabpanel">
                        <div id="reservasContainer" runat="server">
                            <!-- Reservas ser�o carregadas aqui -->
                        </div>
                    </div>
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th>Nome</th>
                                                <th>Descri��o</th>
                                                <th>Permite Altera��o</th>
                                                <th>Permite Exclus�o</th>
                                                <th>Ordem</th>
                                                <th>A��es</th>
                                            </tr>
                                        </thead>
                    ...
                    <div class="tab-pane fade" id="logs" role="tabpanel">
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="diasLogs" class="form-label">Per�odo (dias):</label>
                                    <select class="form-select" id="diasLogs" onchange="carregarLogs()">
                                        <option value="1">�ltimo dia</option>
                                        <option value="3">�ltimos 3 dias</option>
                                        <option value="7" selected>�ltimos 7 dias</option>
                    ...
                    <div class="tab-pane fade" id="configuracoes" role="tabpanel">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h5 class="mb-0"><i class="fas fa-cog"></i> Configura��es do Sistema</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <h6 class="border-bottom pb-2"><i class="fas fa-globe"></i> Configura��es Gerais</h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <asp:DropDownList ID="ddlEnvironment" runat="server" CssClass="form-select">
                                            ...
                                            <asp:ListItem Value="Production">Produ��o</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <h6 class="border-bottom pb-2 mt-4"><i class="fas fa-envelope"></i> Configura��es de Email</h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Usu�rio SMTP (Email) *</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">Para Gmail, use uma Senha de App (n�o a senha normal)</small>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <asp:Button ID="btnSalvarConfiguracoes" runat="server" Text="Salvar Configura��es" CssClass="btn btn-primary btn-lg" OnClick="btnSalvarConfiguracoes_Click" />
                                        <button type="button" class="btn btn-secondary btn-lg" onclick="alert('Funcionalidade de teste de email ser� implementada em breve.');">Testar Email</button>
                                    </div>
                                </div>
                                
                                <div class="alert alert-info mt-3">
                                    <i class="fas fa-info-circle"></i> <strong>Nota:</strong> As configura��es s�o salvas no arquivo web.config. 
                                    Para altera��es em produ��o, edite o arquivo Web.Release.config ou o web.config diretamente no servidor.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <!-- Coluna Esquerda: Informa��es B�sicas -->
                            <div class="col-lg-8">
                                <!-- Se��o: Informa��es B�sicas -->
                                <div class="card mb-4 border-0 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0">
                                            <i class="fas fa-info-circle text-primary"></i> Informa��es B�sicas
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">
                                                <i class="fas fa-align-left text-muted"></i> Descri��o
                                            </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">
                                                        <i class="fas fa-dollar-sign text-success"></i> Pre�o (R$) *
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">
                                                        <i class="fas fa-sort-numeric-up text-muted"></i> Ordem de Exibi��o
                                                    </label>
                                                    <asp:TextBox ID="txtOrdem" runat="server" CssClass="form-control" TextMode="Number" value="0"></asp:TextBox>
                                                    <small class="text-muted">Produtos com menor n�mero aparecem primeiro</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted d-block mt-1">
                                                        <i class="fas fa-info-circle"></i> Formatos: JPG, PNG, GIF, WEBP | M�n: 200x200px | M�x: 5MB
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="text-center mt-3">
                                            <div class="preview-imagem-container">
                                                ...
                                                <div id="previewPlaceholder" class="text-muted p-4 border rounded" style="display: none;">
                                                    ...
                                                    <p class="mb-0">Preview da imagem aparecer� aqui</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">
                                                        <i class="fas fa-calendar-check text-success"></i> Reserv�vel at�
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">
                                                        <i class="fas fa-calendar-times text-danger"></i> Vend�vel at�
                                                    </label>
                                ...
                                <!-- Se��o: Saco Promocional -->
                                <div class="card mb-4 border-0 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0">
                                            <i class="fas fa-gift text-primary"></i> Configura��es Promocionais
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label fw-bold" for="<%= chkEhSacoPromocional.ClientID %>">
                                                    <i class="fas fa-shopping-bag"></i> Este produto � um Saco Promocional
                                                </label>
                                            </div>
                                        </div>
                                        <div id="divSacoPromocional" style="display: none;" class="border-top pt-3 mt-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <small class="text-muted">
                                                    <i class="fas fa-info-circle"></i> Selecione os produtos permitidos (Ctrl+Clique para m�ltiplos)
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-4 border-0 shadow-sm sticky-top" style="top: 20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">Produtos inativos n�o aparecem no site</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <asp:Button ID="btnSalvarProduto" runat="server" Text="Salvar Altera��es" CssClass="btn btn-primary" OnClick="btnSalvarProduto_Click" OnClientClick="return validarESalvarProduto();" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Pre�o (R$) *</label>
                            <asp:TextBox ID="txtNovoPreco" runat="server" CssClass="form-control" TextMode="Number" step="0.01"></asp:TextBox>
                            <small class="text-muted">O tamanho (Pequeno/Grande) deve ser inclu�do no nome do produto</small>
                        </div>
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Formatos aceitos: JPG, PNG, GIF, WEBP. Tamanho m�nimo: 200x200px. Tamanho m�ximo: 5MB. A imagem ser� redimensionada automaticamente.</small>
                        </div>
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Cole aqui a URL da imagem (pode ser do Google Drive, Imgur, etc) se preferir n�o fazer upload</small>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Ordem de Exibi��o</label>
                            <asp:TextBox ID="txtNovaOrdem" runat="server" CssClass="form-control" TextMode="Number" value="0"></asp:TextBox>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Reserv�vel at�</label>
                                    <asp:TextBox ID="txtNovoReservavelAte" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                                    <small class="text-muted">Data at� quando o produto pode ser reservado</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Vend�vel at�</label>
                                    <asp:TextBox ID="txtNovoVendivelAte" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                                    <small class="text-muted">Data at� quando o produto pode ser vendido</small>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div id="divNovoSacoPromocional" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Selecione os produtos que podem ser escolhidos para este saco (segure Ctrl para selecionar m�ltiplos)</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Ordem de exibi��o (menor n�mero aparece primeiro)</small>
                        </div>
                        <div class="mb-3">
                            <div class="form-check">
    ...
    <!-- Garantir que __doPostBack esteja dispon�vel -->
    ...
    <!-- Scripts espec�ficos da p�gina Admin -->
    <script src="../Scripts/admin.js"></script>
    <script type="text/javascript">
        // Fun��o para expandir/colapsar grupos de log
        ...
        // Fun��o para carregar logs com per�odo selecionado
        ...
        function toggleSacoPromocional(checkbox) {
            ...
            if (div) {
                ...
                // Desabilitar valida��o quando div estiver oculta
                ...
                if (txtQuantidadeSaco) {
                    if (!checkbox.checked) {
                        ...
                        // N�o adicionar min aqui, pois pode causar problemas se a div for ocultada novamente
                    }
                }
            }
        }
        ...
        function excluirReserva(reservaId, nome) {
            if (confirm('Tem certeza que deseja excluir a reserva de "' + nome + '"?\n\nEsta a��o n�o pode ser desfeita e enviar� um email ao cliente.')) {
                __doPostBack('excluirReserva', reservaId);
            }
        }
        
        // Fun��o para atualizar preview da imagem ao digitar URL
        function atualizarPreviewImagem(input) {
            ...
            if (url) {
                ...
                preview.style.display = 'none';
                placeholder.style.display = 'block';
                placeholder.innerHTML = '<i class="fas fa-image fa-3x mb-2"></i><p class="mb-0">Preview da imagem aparecer� aqui</p>';
            }
        }
        
        // Atualizar preview quando o modal de edi��o abrir
        ...
        // Fun��o global para desabilitar valida��o de campos ocultos
        function desabilitarValidacaoCamposOcultos() {
            // Desabilitar valida��o de campos em divs ocultas
            ...
            // Desabilitar valida��o de campos em modais ocultos
            ...
            modais.forEach(function(modalId) {
                ...
                if (modal) {
                    ...
                    if (!isModalVisible) {
                        ...
                        // Desabilitar valida��o de campos com min/max
        ...
        // Resetar modal quando fechar e desabilitar valida��o de campos ocultos
        document.addEventListener('DOMContentLoaded', function() {
            // Desabilitar valida��o de campos ocultos ao carregar a p�gina
            desabilitarValidacaoCamposOcultos();
            
            // Interceptar todos os submits do formul�rio para garantir valida��o
            var form = document.getElementById('form1');
            if (form) {
            ...
            // Desabilitar valida��o de campos ocultos quando modais de produto forem fechados
            var modalEditarProduto = document.getElementById('modalEditarProduto');
            if (modalEditarProduto) {
    ...
    <script>
        // Scripts inline apenas para dados din�micos do servidor (ClientIDs)
        (function() {
            function init() {
    ...
    <script>
        // Fun��o para mostrar detalhes da reserva (Admin)
        function mostrarDetalhesReservaAdmin(reservaId) {
            // Fazer requisi��o para obter detalhes da reserva
            __doPostBack('obterDetalhesReserva', reservaId.toString());
        }
        
        // Fun��o para mostrar detalhes do cliente
        function mostrarDetalhesCliente(clienteId) {
            // Fazer requisi��o para obter detalhes do cliente
            __doPostBack('obterDetalhesCliente', clienteId.toString());
        }
        
        // Fun��o para mostrar detalhes do produto
        function mostrarDetalhesProduto(produtoId) {
            // Fazer requisi��o para obter detalhes do produto
