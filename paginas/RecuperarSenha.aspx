<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarSenha.aspx.cs" Inherits="KingdomConfeitaria.paginas.RecuperarSenha" EnableViewState="false" ViewStateMode="Disabled" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="recovery-container">
            ...
            <div class="d-grid mb-3">
                <asp:Button ID="btnEnviar" runat="server" Text="Enviar Link de Recupera��o" CssClass="btn btn-success btn-lg" OnClick="btnEnviar_Click" />
            </div>
