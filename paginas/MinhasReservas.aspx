<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MinhasReservas.aspx.cs" Inherits="KingdomConfeitaria.paginas.MinhasReservas" EnableViewState="false" ViewStateMode="Disabled" %>
...
<body>
    ...
    <!-- Scripts espec�ficos da p�gina MinhasReservas -->
    ...
    <script>
        // Fun��o para mostrar detalhes da reserva
        function mostrarDetalhesReserva(reservaId) {
            ...
            try {
                ...
                if (reserva.linkReserva) {
                    ...
                    html += '<i class="fas fa-external-link-alt"></i> Ver P�gina da Reserva';
                    html += '</a>';
                    html += '</div>';
                }
        ...
        // Fun��es adicionais espec�ficas da p�gina
        ...
        function cancelarReserva(reservaId) {
            if (confirm('Tem certeza que deseja cancelar esta reserva? Esta a��o n�o pode ser desfeita.')) {
                KingdomConfeitaria.Utils.postBack('CancelarReserva', reservaId.toString());
            }
        }

        function excluirReserva(reservaId) {
            if (confirm('Tem certeza que deseja excluir esta reserva? Esta a��o n�o pode ser desfeita.')) {
